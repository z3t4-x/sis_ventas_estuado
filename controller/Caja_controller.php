<?php
	...
	class Caja {
		...
		public function Listar_Datos_Fecha($fecha,$idcaja){
			...
			$filas = CajaModel::Listar_Datos_Fecha($fecha,$idcaja);
			return $filas;
		...
		public function Listar_Movimientos_Fecha($fecha,$idcaja){
			...
			$filas = CajaModel::Listar_Movimientos_Fecha($fecha,$idcaja);
			return $filas;

		}
		public function Listar_Movimientos_Detalle_Fecha($fecha,$idcaja){

			$filas = CajaModel::Listar_Movimientos_Detalle_Fecha($fecha,$idcaja);
			return $filas;
