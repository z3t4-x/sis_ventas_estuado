<?php
	...
	class CajaModel extends Conexion
	{
		...
		public function Listar_Datos_Fecha($fecha,$idcaja)
		{
			...
			try
			{
				$query = "CALL sp_view_datos_caja_fecha(:fecha,:idcaja);";
				$stmt = $dbconec->prepare($query);
		...
		public function Listar_Movimientos_Fecha($fecha,$idcaja)
		{
			...
			try
			{
				$query = "CALL sp_view_movimientos_caja_fecha(:fecha,:idcaja);";
				$stmt = $dbconec->prepare($query);
				$stmt->bindParam(":fecha",$fecha);
			    $stmt->bindParam(":idcaja",$idcaja);
				$stmt->execute();
		...
		public function Listar_Movimientos_Detalle_Fecha($fecha,$idcaja)
		{
			...
			try
			{
				$query = "CALL sp_view_movimientos_detalle_fecha(:fecha,:idcaja);";
				$stmt = $dbconec->prepare($query);
				$stmt->bindParam(":fecha",$fecha);
				$stmt->bindParam(":idcaja",$idcaja);
				$stmt->execute();
