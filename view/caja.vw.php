<?php
 ...
 if(is_array($movimientos) || is_object($movimientos))
 {
	foreach ($movimientos as $row => $column) {
		...
		$ingresos_tarjeta = $column['p_ingresos_tarjeta'];
							...
							<div class="heading-elements">
								...
								<?php } else if ($veces_abierta == "1" && $estado_caja == "1"){?>
									...
									<ul class="dropdown-menu dropdown-menu-right">
										...
										<li><a href="reportes/Reporte_Caja.php?fecha=<?php echo DateTime::createFromFormat('Y-m-d H:i:s',$fecha_apertura)->format('Y-m-d')?>&idcaja=<?php print($idcaja); ?>" target="_blank"
										...
										<table class="table table-xxs">
											<tbody>
												...
												<tr>
													...
													<td class="text-teal"><left>INGRESOS ( Efectivo )</left> <a data-toggle="modal" data-target=".bs-example-modal-sm" style='color:#5b5d5f'> </a></td>
													<td></td>
													<td id="ingresos" class="text-right"><?php if($ingresos!='')echo  $simbolo.' '.$ingresos; else echo $simbolo.' 0.00'; ?></td>
												</tr>
												<tr>
													<td><i class="icon-square"  style="color:#5cb85c;" aria-hidden="true"></i></td>
													<td class="text-teal"><left>INGRESOS ( Yape/Tarjeta )</left> <a data-toggle="modal" data-target=".bs-example-modal-sm" style='color:#5b5d5f'> </a></td>
													<td></td>
													<td id="ingresos_tarjeta" class="text-right"><?php if($ingresos_tarjeta!='')echo  $simbolo.' '.$ingresos_tarjeta; else echo $simbolo.' 0.00'; ?></td>
												</tr>
												<tr>
												...
												<tr class="">
													<td class=""></td>
													<td class=""><h5><left><strong>SALDO EN CAJA</strong></left></h5></td>
													<th class=""></th>
													<th class="text-right"><h5><strong id="Saldo"><?php if($saldo!='')echo  $simbolo.' '.$saldo; else echo $simbolo.' 0.00'; ?></strong></h5></th>
												</tr>
												<tr class="">
													<td class=""></td>
													<td class="text-info"><h5><left><strong>MONTO INICIAL + SALDO EN CAJA</strong></left></h5></td>
													<th class=""></th>
														  ...
														  <?php
																...
																?>
																	<tr>
													                	...
													                	<td><?php print($column['monto_movimiento_tarjeta']); ?></td>
													                </tr>
																<?php
																		}
																	}
