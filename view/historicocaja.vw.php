										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a href="reportes/Reporte_Caja.php?fecha=<?php echo DateTime::createFromFormat('Y-m-d H:i:s',$fecha_apertura)->format('Y-m-d')?>&idcaja=<?php print($column['idcaja']); ?>" target="_blank">
