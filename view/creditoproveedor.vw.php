					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li><a href="javascript:;">Compras al Credito</a></li>
								<li class="active">Administrar Credito</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h5 class="panel-title">Administracion de Creditos - Proveedor</h5>
						</div>
											 ...
											 class="select-search" style="text-transform:uppercase;"
												 onkeyup="javascript:this.value=this.value.toUpperCase();">
													<?php
														 ...
														 {
														 ?>
															 <option value="<?php print ($column["idcreditoproveedor"])?>">
															 <?php print ($column["codigo_credito"].' - '.$column["proveedor"])?></option>
														 <?php
															 }
														 }
													?>
										...
										<div class="panel-body">
											<div class="table-responsive">
												<table class="table table-xxs table-bordered">
												 ...
												 <tr>
												 	<td width="5%" class="text-bold text-left">NO. COMPRA</td>
													<td width="35%"></td>
												...
												<tr>
													...
													<td width="30%"></td>
													<td width="2%" class="text-bold text-left">FECHA COMPRA</td>
													<td width="30%"></td>
												</tr>
												<tr>
